...
@Ignore("CAM-13435")
public class SetVariablesAsyncContextSwitchTest extends AbstractFoxPlatformIntegrationTest {
      ...
      .startEvent()
        .intermediateCatchEvent("foo")
          .conditionalEventDefinition()
            .camundaVariableEvents(Collections.singletonList("create"))
            .condition("${foo.prio == 5}")
